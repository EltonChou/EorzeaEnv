...
weather: Mapping[
    int, Mapping[Union[EorzeaLang, Literal["de", "en", "fr", "ja"]], Optional[str]]
] = {
    ...
    8: {"de": "Wolkenbruch", "en": "Showers", "fr": "Pluie torrentielle", "ja": "暴雨"},
    9: {"de": "Gewittrig", "en": "Thunder", "fr": "Orages", "ja": "雷"},
    10: {"de": "Gewitter", "en": "Thunderstorms", "fr": "Orages violents", "ja": "雷雨"},
    11: {
        "de": "Staubig",
        "en": "Dust Storms",
    ...
    12: {"de": "Sandsturm", "en": "Sandstorms", "fr": "Tempêtes de sable", "ja": "砂嵐"},
    ...
    22: {"de": "Wetterleuchten", "en": "Storm Clouds", "fr": "Orageux", "ja": "雷雲"},
    ...
    29: {"de": "Rauchschwaden", "en": "Eruptions", "fr": "Éruptions", "ja": "噴煙"},
    ...
    35: {"de": "Blendend", "en": "Irradiance", "fr": "Rayonnement", "ja": "極光"},
    36: {
        "de": "Kernstrahlung",
        "en": "Core Radiation",
    ...
    44: {"de": "Bedrückend", "en": "Oppression", "fr": "Oppression", "ja": "神意"},
    45: {"de": "Bedrückend", "en": "Oppression", "fr": "Oppression", "ja": "神意"},
    46: {"de": "Bedrückend", "en": "Oppression", "fr": "Oppression", "ja": "神意"},
    47: {"de": "Bedrückend", "en": "Oppression", "fr": "Oppression", "ja": "神意"},
    48: {"de": "Bedrückend", "en": "Oppression", "fr": "Oppression", "ja": "神意"},
    49: {"de": "Schattenwind", "en": "Umbral Wind", "fr": "Vent ombral", "ja": "霊風"},
    50: {
        "de": "Schattengewitter",
        "en": "Umbral Static",
        "fr": "Charges ombrales",
    ...
    60: {"de": "Mystisch", "en": "Multiplicity", "fr": "Multiplicité", "ja": "神秘"},
    61: {"de": "Mystisch", "en": "Multiplicity", "fr": "Multiplicité", "ja": "神秘"},
    ...
    66: {"de": "Hass", "en": "Dragonstorms", "fr": "Tempête de haine", "ja": "邪天"},
    67: {"de": "Hass", "en": "Dragonstorms", "fr": "Tempête de haine", "ja": "邪天"},
    68: {"de": "Unterirdisch", "en": "Subterrain", "fr": "Souterrain", "ja": "晴れ"},
    69: {"de": "Gerechtigkeit", "en": "Concordance", "fr": "Harmonie", "ja": "調和"},
    70: {"de": "Gerechtigkeit", "en": "Concordance", "fr": "Harmonie", "ja": "調和"},
    71: {"de": "Zeitfluss", "en": "Beyond Time", "fr": "Hors du temps", "ja": "時流"},
    72: {"de": "Zeitfluss", "en": "Beyond Time", "fr": "Hors du temps", "ja": "時流"},
    73: {"de": "Zeitfluss", "en": "Beyond Time", "fr": "Hors du temps", "ja": "時流"},
    74: {
    ...
    80: {"de": "Feiersturm", "en": "Revelstorms", "fr": "Tempête festive", "ja": "嵐天"},
    81: {"de": "Feiersturm", "en": "Revelstorms", "fr": "Tempête festive", "ja": "嵐天"},
    82: {
        "de": "Ewigschön",
        "en": "Eternal Bliss",
    ...
    86: {"de": "Feiersturm", "en": "Revelstorms", "fr": "Tempête festive", "ja": "嵐天"},
    87: {"de": "Blitzsturm", "en": "Quicklevin", "fr": "Vif-orage", "ja": "迅雷"},
    ...
    95: {"de": "Ultimativ", "en": "Ultimania", "fr": "Fantasmagorique", "ja": "幻想"},
    96: {
        "de": "Weißer Zyklon",
        "en": "White Cyclones",
        "fr": "Tempête blanche",
    ...
    101: {"de": "Roter Mond", "en": "Red Moon", "fr": "Lune rouge", "ja": "紅月下"},
    ...
    119: {"de": "Stürmisch", "en": "Gales", "fr": "Vents violents", "ja": "暴風"},
    120: {"de": "Apokalyptisch", "en": "Termination", "fr": "Apocalypse", "ja": "終末"},
    121: {"de": "Apokalyptisch", "en": "Termination", "fr": "Apocalypse", "ja": "終末"},
    ...
    127: {"de": "Apokalyptisch", "en": "Termination", "fr": "Apocalypse", "ja": "終末"},
    128: {"de": "Apokalyptisch", "en": "Termination", "fr": "Apocalypse", "ja": "終末"},
    129: {
        "de": "Ewiges Licht",
        "en": "Everlasting Light",
        "fr": "Clarté éternelle",
    ...
    130: {"de": "Rauchschwaden", "en": "Eruptions", "fr": "Éruptions", "ja": "噴煙"},
    131: {"de": "Apokalyptisch", "en": "Termination", "fr": "Apocalypse", "ja": "終末"},
    ...
    141: {"de": "Blendend", "en": "Irradiance", "fr": "Rayonnement", "ja": "極光"},
    142: {"de": "Blendend", "en": "Irradiance", "fr": "Rayonnement", "ja": "極光"},
    143: {"de": "Wetterleuchten", "en": "Storm Clouds", "fr": "Orageux", "ja": "雷雲"},
    144: {
        "de": "Flammensturm",
        "en": "Firestorm",
        "fr": "Tempête de feu",
    ...
    150: {"de": "Apokalypse", "en": "Apocalypse", "fr": "Apocalypse", "ja": "終末"},
    151: {
        "de": "Polarisierend",
        "en": "Polarization",
        "fr": "Polarisation",
    ...
    157: {"de": "Pandæmonium", "en": "Pandæmonium", "fr": "Pandæmonium", "ja": "万魔殿"},
    158: {"de": "Pandæmonium", "en": "Pandæmonium", "fr": "Pandæmonium", "ja": "万魔殿"},
    159: {"de": "Pandæmonium", "en": "Pandæmonium", "fr": "Pandæmonium", "ja": "万魔殿"},
    160: {"de": "Eschatologie", "en": "Ultimatum", "fr": "Eschatologique", "ja": "終極"},
    161: {"de": "Verzweifelnd", "en": "Inevitability", "fr": "Désespoir", "ja": "絶望"},
    162: {
        "de": "Götterwetter",
        "en": "Transcendence",
        "fr": "Mythologique",
    ...
    170: {"de": "Hass", "en": "Dragonstorms", "fr": "Tempête de haine", "ja": "邪天"},
